                ...
                <div className='w-100 mx-auto my-3 text-white row' style={{ backgroundColor: "red" }}>
                    <div className="centered row p-3">
                        <div className="centered col-4 my-auto px-4">
                            <div>
                                <h1 className='text-warning m-2'>Benefits of Donating Blood via BloodBond</h1>
                                <h4 className='mx-5 my-3'>BloodBond is an online Blood Donation platform that envisions to save lives of people by providing them blood during need and helping in connecting beneficiaries to ease out the process of Blood Donation</h4>
                    ...
                    <div className="centered col">
                        <div className="centered flex justify-content-center row p-5 mx-5 my-3 rounded" style={{ backgroundColor: "red", boxShadow: "#282929 5px 10px 10px" }}>
                            <div className='col-8 col-md-7'>
                                ...
                                <h4>BloodBond will pursue to enhance the services for the donors and receivers by providing safe supply of Blood. We will put continous efforts to keep on improving the managment system to make it more reliable.</h4>
                            </div>
                        ...
                        <div className="centered flex justify-content-center row mt-1 p-5 mx-5 my-3 rounded" style={{ backgroundColor: "red", boxShadow: "#282929 5px 10px 10px" }}>
                            <div className='col-8 col-md-7'>
                                ...
                                <h4>BloodBond visions to save lives of people by providing them Blood during need, by making the country self-sufficient in the availability of Blood for donation. We are dedicated to provide immediate help to people and bring smiles on millions of faces.</h4>
                            </div>
                            <div className="centered col-md-3 my-auto">
