...
const requestRaisedTemplate = require('../models/RequestRaisedModel')
const donorRegistrationTemplate = require('../models/DonorRegistrationModel')
const receiverRegistrationTemplate = require('../models/ReceiverRegistrationModel')
const internRegistrationTemplate = require('../models/InternRegistrationModel')
const celebrityRegistrationTemplate = require('../models/CelebrityRegistrationModel')
const ngoRegistrationTemplate = require("../models/NgoRegistrationModel")
const companyRegistrationTemplate = require("../models/CompanyRegistrationModel")
const schoolRegistrationTemplate = require("../models/SchoolRegistrationModel")
const collegeRegistrationTemplate = require("../models/CollegeRegistrationModel")
const hospitalRegistrationTemplate = require("../models/HospitalRegistrationModel")
const politicalPartyRegistrationTemplate = require("../models/PoliticalPartyRegistrationModel")
const ocassionalDonorRegistrationTemplate = require('../models/OcassionalDonorRegistrationModel')
