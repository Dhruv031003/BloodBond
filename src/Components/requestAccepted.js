        ...
        <>
            ...
            <div className='w-50 m-5 p-5 d-flex justify-content-center align-items-center bg-danger mx-auto flex-wrap'>
                <div className='w-auto p-3 text-center'>
                    <h1 className='text-warning'>Thanks for accepting the request.</h1>
                    <h5 className='text-warning'>You'll be contacted shortly from our side or you can contact us on the information given below.</h5>
