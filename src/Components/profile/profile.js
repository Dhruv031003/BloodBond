            ...
            <div className="row w-100 p-3 m-0">
                <div className="col-auto col-md-6 col-sm-12 mx-1 px-2 my-0">
                    ...
                    <div className='m-4 my-2 w-100'>
                        <h4 className='py-3'>UserName :- Dhruv Dorbi</h4>
                        <h4 className='py-3'>DOB :- 03/XX/20XX</h4>
                        <h4 className='py-3'>AGE :- 20</h4>
                        <h4 className='py-3'>Blood Group :- O+ve</h4>
                        <h4 className='py-3'>Address :- Gwalior</h4>
                        <h4 className='py-3'>Type of User :- Donor</h4>
                        <h4 className='py-3'>Phone Number :- 6261XXXXXX</h4>
